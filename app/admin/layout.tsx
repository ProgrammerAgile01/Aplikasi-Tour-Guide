...
import { LayoutDashboard, Calendar, Users, CheckSquare, Megaphone, BarChart3, LogOut, Menu, X } from "lucide-react"
...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { name: "Absensi & Kehadiran", path: "/admin/attendance", icon: CheckSquare },
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center px-6 border-b border-slate-200">
            <h1 className="font-bold text-lg text-slate-900">Trip Komodo Admin</h1>
          </div>
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive ? "bg-blue-50 text-blue-600 font-medium" : "text-slate-700 hover:bg-slate-100"}
                  `}
                >
                  <Icon size={20} />
